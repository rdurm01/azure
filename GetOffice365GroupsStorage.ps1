...
( 
  ...
  $NoMFA,
  $UserName = "rupert.duermoser@landsalzburg.onmicrosoft.com"
  $Password = $null,
  $TenantName = $null
...
{ 
  ...
  { 
    ...
    install-module System.Management.Automation
...
if($NoMFA.IsPresent)
{
 ...
 if($TenantName -eq "")
 {
  ...
  Connect-PnPOnline -Url https://landsalzburg.sharepoint.com/ -Credentials $Credential

    Connect-PnPOnline -Url https://landsalzburg.sharepoint.com  -
